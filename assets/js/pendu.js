const words = ["ordinateur", "javascript", "programmation", "pendu", "developpeur", "isotherme", "abeille", "bateau", "bricolage", "groupe", "seminaire", "projet", "chat", "place", "efficom", "livre", "question", "piano", "calendrier", "medecin", "ballon", "vodka", "casino", "confortable", "plateau", "etoile", "timbre", "voiture", "fantaisie", "volcan","chat", "sole", "lune", "pain", "riz", "clé", "eau", "feu", "roi", "mur", "sel", "air", "fil", "ciel", "neige", "vent", "jour", "nuit", "or", "vin", "avion", "forêt", "bouteille", "chanson", "maison", "montagne", "fenêtre", "ordinateur", "voyage", "camion", "piscine", "chocolat", "coussin", "tableau", "bibliothèque", "muraille", "miroir", "biscuit", "jardin", "étoiles", "tambour", "poisson", "coquille", "développement", "extraordinaire", "bibliothèque", "informatique", "responsabilité", "architecture", "incontournable", "incroyablement", "philosophique", "réfrigérateur", "transformation", "administration", "interprétation", "environnement", "impressionnant", "organisation", "communication", "révolutionnaire", "considérablement", "international", "brouette"]; /* mots possibles */
