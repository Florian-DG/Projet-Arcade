const words = ["ordinateur", "javascript", "programmation", "pendu", "developpeur", "isotherme", "abeille", "bateau", "bricolage", "groupe", "seminaire", "projet", "chat", "place", "efficom", "livre", "question", "piano", "calendrier", "medecin", "ballon", "vodka", "casino", "confortable", "plateau", "etoile", "timbre", "voiture", "fantaisie", "volcan","chat", "sole", "lune", "pain", "riz", "clé", "eau", "feu", "roi", "mur", "sel", "air", "fil", "ciel", "neige", "vent", "jour", "nuit", "or", "vin", "avion", "foret", "bouteille", "chanson", "maison", "montagne", "fenetre", "ordinateur", "voyage", "camion", "piscine", "chocolat", "coussin", "tableau", "bibliotheque", "muraille", "miroir", "biscuit", "jardin", "etoiles", "tambour", "poisson", "coquille", "developpement", "extraordinaire", "bibliotheque", "informatique", "responsabilite", "architecture", "incontournable", "incroyablement", "philosophique", "refrigerateur", "transformation", "administration", "interpretation", "environnement", "impressionnant", "organisation", "communication", "revolutionnaire", "considerablement", "international", "brouette"]; /* mots possibles */
